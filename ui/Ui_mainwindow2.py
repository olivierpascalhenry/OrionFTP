...
"}")
        ...
        self.main_quit_bt = QtWidgets.QToolButton(self.widget)
        self.main_quit_bt.setMinimumSize(QtCore.QSize(35, 35))
        self.main_quit_bt.setMaximumSize(QtCore.QSize(35, 35))
        self.main_quit_bt.setStyleSheet("QToolButton {\n"
"   background-color: transparent;\n"
"   border: 0px solid black;\n"
"}")
        self.main_quit_bt.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/exit_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_quit_bt.setIcon(icon2)
        self.main_quit_bt.setIconSize(QtCore.QSize(33, 33))
        self.main_quit_bt.setObjectName("main_quit_bt")
        self.horizontalLayout_7.addWidget(self.main_quit_bt)
        self.main_option_bt = QtWidgets.QToolButton(self.widget)
        self.main_option_bt.setMinimumSize(QtCore.QSize(35, 35))
        self.main_option_bt.setMaximumSize(QtCore.QSize(35, 35))
        self.main_option_bt.setStyleSheet("QToolButton {\n"
"   background-color: transparent;\n"
"   border: 0px solid black;\n"
"}")
        self.main_option_bt.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icons/option_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_option_bt.setIcon(icon3)
        self.main_option_bt.setIconSize(QtCore.QSize(35, 35))
        self.main_option_bt.setObjectName("main_option_bt")
        self.horizontalLayout_7.addWidget(self.main_option_bt)
        self.main_about_bt = QtWidgets.QToolButton(self.widget)
        self.main_about_bt.setMinimumSize(QtCore.QSize(35, 35))
        self.main_about_bt.setMaximumSize(QtCore.QSize(35, 35))
        self.main_about_bt.setStyleSheet("QToolButton {\n"
"   background-color: transparent;\n"
"   border: 0px solid black;\n"
"}")
        self.main_about_bt.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icons/about_popup_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_about_bt.setIcon(icon4)
        self.main_about_bt.setIconSize(QtCore.QSize(35, 35))
        self.main_about_bt.setObjectName("main_about_bt")
        self.horizontalLayout_7.addWidget(self.main_about_bt)
        self.main_update_bt = QtWidgets.QToolButton(self.widget)
        self.main_update_bt.setEnabled(False)
        self.main_update_bt.setMinimumSize(QtCore.QSize(35, 35))
        self.main_update_bt.setMaximumSize(QtCore.QSize(35, 35))
        self.main_update_bt.setStyleSheet("QToolButton {\n"
"   background-color: transparent;\n"
"   border: 0px solid black;\n"
"}")
        self.main_update_bt.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("icons/orionftp_update_off.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_update_bt.setIcon(icon5)
        self.main_update_bt.setIconSize(QtCore.QSize(35, 35))
        self.main_update_bt.setObjectName("main_update_bt")
        self.horizontalLayout_7.addWidget(self.main_update_bt)
        spacerItem8 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_7.addItem(spacerItem8)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setSpacing(0)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.main_upload_bt = QtWidgets.QToolButton(self.widget)
...
"}")
        ...
        self.main_upload_bt_2 = QtWidgets.QToolButton(self.widget)
...
"}")
        ...
        self.main_download_bt_2 = QtWidgets.QToolButton(self.widget1)
...
"}")
        ...
        self.main_download_bt = QtWidgets.QToolButton(self.widget1)
...
"}")
        ...
        self.main_refresh_bt = QtWidgets.QToolButton(self.widget1)
        self.main_refresh_bt.setEnabled(False)
        self.main_refresh_bt.setMinimumSize(QtCore.QSize(35, 35))
        self.main_refresh_bt.setMaximumSize(QtCore.QSize(35, 35))
        self.main_refresh_bt.setStyleSheet("QToolButton {\n"
"   background-color: transparent;\n"
"   border: 0px solid black;\n"
"}")
        self.main_refresh_bt.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("icons/reload_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_refresh_bt.setIcon(icon8)
        self.main_refresh_bt.setIconSize(QtCore.QSize(35, 35))
        self.main_refresh_bt.setObjectName("main_refresh_bt")
        self.horizontalLayout_5.addWidget(self.main_refresh_bt)
        self.main_close_bt = QtWidgets.QToolButton(self.widget1)
        self.main_close_bt.setEnabled(False)
        self.main_close_bt.setMinimumSize(QtCore.QSize(35, 35))
        self.main_close_bt.setMaximumSize(QtCore.QSize(35, 35))
        self.main_close_bt.setStyleSheet("QToolButton {\n"
"   background-color: transparent;\n"
"   border: 0px solid black;\n"
"}")
        self.main_close_bt.setText("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("icons/off_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_close_bt.setIcon(icon9)
        self.main_close_bt.setIconSize(QtCore.QSize(35, 35))
        self.main_close_bt.setObjectName("main_close_bt")
        self.horizontalLayout_5.addWidget(self.main_close_bt)
...
"}")
        ...
        self.main_tabwidget = QtWidgets.QTabWidget(self.splitter_2)
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("icons/separator_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon10.addPixmap(QtGui.QPixmap("icons/separator_icon.png"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        self.actionSeparator.setIcon(icon10)
        ...
        self.actionSeparator3.setIcon(icon10)
        self.actionSeparator3.setObjectName("actionSeparator3")
        self.actionManager = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("icons/manager_icon.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionManager.setIcon(icon11)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.main_local_ln.setText(_translate("MainWindow", "Local:"))
