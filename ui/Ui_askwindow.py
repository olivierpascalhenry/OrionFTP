...
"}")
        ...
        sizePolicy.setHeightForWidth(self.aw_label_2.sizePolicy().hasHeightForWidth())
        self.aw_label_2.setSizePolicy(sizePolicy)
        self.aw_label_2.setMinimumSize(QtCore.QSize(70, 27))
        self.aw_label_2.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setKerning(True)
